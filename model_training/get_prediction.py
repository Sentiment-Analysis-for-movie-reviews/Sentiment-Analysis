...
from .performance import ClassificationEvaluation

# I don't understand why these code here
# Task 10: Loading and Evaluating our Model
def load_and_evaluate_our_model(dataloader_val, label_dict, device):
    ...
    return ClassificationEvaluation.accuracy_per_class(predictions, true_vals)
